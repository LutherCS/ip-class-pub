...
3. Add a new web app (Flask on Python 3.12). Note that your application file is going to be overwritten, you'll need to check it out from your repository.
...
4. Set environment variable `PYTHON_VERSION` to `3.12.3`.
